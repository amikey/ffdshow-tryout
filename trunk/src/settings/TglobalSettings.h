...
#define WHITELIST_EXE_FILENAME \
    _l("3wPlayer.exe;ACDSee10.exe;ACDSee11.exe;ACDSee5.exe;ACDSee6.exe;ACDSee7.exe;ACDSee8.exe;ACDSee8Pro.exe;ACDSee9.exe;ACDSeePro2.exe;ACDSeePro25.exe;acdseepro3.exe;aegisub.exe;afreecaplayer.exe;")\
    _l("afreecastudio.exe;AfterFX.exe;aim6.exe;ALLPlayer.exe;allradio.exe;AlltoaviV4.exe;ALShow.exe;ALSong.exe;AltDVB.exe;amcap.exe;amf_slv.exe;amvtransform.exe;Apollo DivX to DVD Creator.exe;Apollo3GPVideoConverter.exe;")\
    _l("Ares.exe;AsfTools.exe;ass_help3r.exe;ASUSDVD.exe;Audition.exe;AutoGK.exe;autorun.exe;avant.exe;AVerTV.exe;Avi2Dvd.exe;avi2mpg.exe;avicodec.exe;avipreview.exe;aviutl.exe;avs2avi.exe;avs2yuv.exe;Badak.exe;")\
    _l("BearShare.exe;BePipe.exe;bestplayer.exe;bestplayer1.0.exe;bestpl~1.exe;BitComet.exe;BlazeDVD.exe;BoonPlayer.exe;bplay.exe;bsplay.exe;bsplayer.exe;BTVD3DShell.exe;CamRecorder.exe;CamtasiaStudio.exe;")\
    ...
    _l("JetAudio.exe;jetvideo.exe;jwBrowser.exe;kiteplayer.exe;kmplayer.exe;KwMusic.exe;LA.exe;LifeCam.exe;LifeFrame.exe;Lilith.exe;makeAVIS.exe;MatroskaDiag.exe;Maxthon.exe;MDirect.exe;Media Center 12.exe;Media Jukebox.exe;Media Player Classic.exe;")\
    _l("MediaLife.exe;mediamonkeyvhelper.exe;MediaPortal.exe;MEDIAREVOLUTION.EXE;MediaServer.exe;megui.exe;mencoder.exe;mercalli.exe;Metacafe.exe;mfpmp.exe;MMPlayer.exe;MovieMaker.exe;moviemk.exe;moviethumb.exe;MP4Converter.exe;Mp4Player.exe;mpc-be.exe;mpc-be64.exe;mpc-hc.exe;mpc-hc_nvo.exe;mpc-hc64.exe;mpc-hc64_nvo.exe;mpcstar.exe;MpegVideoWizard.exe;")\
    ...
    _l("Safari.exe;SelfMV.exe;Shareaza.exe;sherlock2.exe;ShowTime.exe;sidebar.exe;SinkuHadouken.exe;Sleipnir.exe;smartmovie.exe;soffice.bin;songbird.exe;SopCast.exe;START.EXE;staxrip.exe;stereoplayer.exe;stillcap.exe;Studio.exe;subedit.exe;")\
    _l("SubtitleEdit.exe;SubtitleWorkshop.exe;SubtitleWorkshop4.exe;SWFConverter.exe;telewizja.exe;TheaterTek DVD.exe;thumbgen.exe;time_adjuster.exe;timecodec.exe;tmc.exe;TMPGEnc.exe;TMPGEnc4XP.exe;TOTALCMD.EXE;tridefmediaplayer.exe;tsdoctor.exe;TSPlayer.exe;Tvants.exe;")\
    ...
    _l("winamp.exe;WinAVI 9.0.exe;WinAVI MP4 Converter.exe;WinAVI.exe;WindowsPhotoGallery.exe;windvd.exe;WinDvr.exe;WinMPGVideoConvert.exe;WINWORD.EXE;wintv7.exe;WLXPhotoGallery.exe;wmenc.exe;wmplayer.exe;wmprph.exe;")\
    _l("wscript.exe;x264.exe;XNVIEW.EXE;Xvid4PSP.exe;zplayer.exe;Zune.exe;")

#define BLACKLIST_EXE_FILENAME \
    _l("age3.exe;aircamwin.exe;an.exe;AvatarMP.exe;BeachSoccer.exe;boostspeed.exe;Bully.exe;civilizationv.exe;civilizationv_dx11.exe;cm2008.exe;cm2010.exe;cmr4.exe;cmr5.exe;conflictdeniedops.exe;conquer.exe;crazy_taxi_pc.exe;crystaleye.exe;daoriginslauncher.exe;dark_horizon.exe;DaybreakDX.exe;DisciplesIII.exe;divinity2.exe;dmc3se.exe;dragonica.exe;dragonage2launcher.exe;drakensang.exe;drome racers.exe;em3.exe;em4.exe;empires_dmw.exe;engine.exe;evochronmercenary.exe;fable.exe;Edition.exe;FalconAF.exe;fallout3.exe;falloutnv.4gb;falloutnv.exe;ff7.exe;ffxiv.exe;fordorr.exe;fr2.exe;fr3.exe;freedom.exe;fsr.exe;game.bin;game.exe;googletalkplugin.exe;Grandia2.exe;gta-vc.exe;gta3.exe;gta_sa.exe;")\
    _l("gta-underground.exe;gta t‹rk.exe;guildII.exe;helpctr.exe;HeroAcademy.exe;hl.exe;hl2.exe;howtosurvive.exe;iclone.exe;juiced.exe;juiced2_hin.exe;KhanClient.exe;king.exe;kmseldi.exe;launch.exe;launcher.exe;launcher_main.exe;ldd.exe;legoracers.exe;lf2.exe;Main.exe;manycam.exe;MassEffectLauncher.exe;MassEffect2Launcher.exe;maxpayne.exe;mixcraft.exe;mixcraft3.exe;mixcraft4.exe;mixcraft5.exe;mixcraft6.exe;mixcra~1.exe;mmloaddrv.exe;morrowind.exe;msninst.exe;nations.exe;ninjablade.exe;NokiaMServer.exe;nokiaovisuite.exe;oblivion.exe;outlook.exe;p2v.exe;patriots.exe;pes2008.exe;pes2009.exe;pes2010.exe;pes4.exe;pes5.exe;pes6.exe;powerdvd8.exe;powerdvd9.exe;powerdvd10.exe;powerdvd11.exe;powerdvd12.exe;powerdvd13.exe;power2go.exe;premiere.exe;pwo.exe;questviewer.exe;rag2.exe;rct.exe;rct3.exe;rct3plus.exe;residentevil3.exe;")\
    _l("rf.exe;rf_online.bin;RomeGame.exe;rometw.exe;sacred.exe;sega rally.exe;setpoint.exe;sh3.exe;sh4.exe;shattered_horizon.exe;shippingpc-skygame.exe;ShogunW.exe;silverlight.configuration.exe;sims.exe;simtractor.exe;skin.exe;smartlogon.exe;SplitCam.exe;stardrive.exe;starsword.exe;StreetFighterIV.exe;streetlegal_redline.exe;SWRepublicCommando.exe;swtfu2.exe;tesv.exe;tw2008.exe;twoworlds.exe;uimain.exe;vircam.exe;vircamws.exe;vmcExtenderSetup.exe;wa.exe;war3.exe;webcamdell.exe;webcamdell2.exe;wlstartup.exe;worms 4 mayhem.exe;worms3d.exe;wormsmayhem.exe;wwp.exe;x3ap.exe;x3tc.exe;Yahoo.Messenger.YmApp.exe;yahoom~1.exe;YahooMessenger.exe;YahooMusicEngine.exe;yahoow~1.exe;YahooWidgetEngine.exe;YahooWidgets.exe;ymini.exe;youcam.exe;zoo.exe;")
